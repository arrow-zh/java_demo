        ...
        $scope.editParam = function (row, index) {
            ...
            $uibModal.open({
                ...
                controller: function ($scope, $uibModalInstance) {
                    $scope.param_types = [
                        {name: translate('CONFIG.DASHBOARD.PARAM_TYPE_SEARCH'), value: 'search'},
                        {name: translate('CONFIG.DASHBOARD.PARAM_TYPE_EQ'), value: 'eq'},
                        {name: translate('CONFIG.DASHBOARD.PARAM_TYPE_URL'), value: 'url'},
                        {name: translate('CONFIG.DASHBOARD.PARAM_TYPE_SELECT'), value: 'select'},
                        {name: translate('CONFIG.DASHBOARD.PARAM_TYPE_CHECKBOX'), value: 'checkbox'}
